...
type
  ...
  public
    ...
    procedure SwapCategories(Index1, Index2: Integer);
    procedure SwapCategoriesByName(const Name1, Name2: string);
...
procedure TBookmarkCollection.SwapCategories(Index1, Index2: Integer);
begin
  if (Index1 >= 0) and (Index1 < Categories.Count) and
     (Index2 >= 0) and (Index2 < Categories.Count) then
  begin
    Categories.Exchange(Index1, Index2);
  end;
end;

procedure TBookmarkCollection.SwapCategoriesByName(const Name1, Name2: string);
var
...
begin
  ...
  begin
    if SameText(Categories[i].Category, Name1) then
      Index1 := i
    else
    if SameText(Categories[i].Category, Name2) then
      Index2 := i;
  end;
  if (Index1 <> - 1) and (Index2 <> - 1) then
    SwapCategories(Index1, Index2);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Cat.Items.Exchange(Index1, Index2);
      end;
      Exit;
    end;
  end;
...
begin
  ...
  begin
    ...
    begin
      ...
      if (Index1 <> - 1) and (Index2 <> - 1) then
        SwapItems(CategoryName, Index1, Index2);
      Exit;
    end;
  end;
end;
